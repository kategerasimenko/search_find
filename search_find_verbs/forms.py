...
class SearchForm(forms.Form):
        ...
        meaning_type = forms.ModelMultipleChoiceField(queryset=MeaningType.objects.all(),required=False,widget=forms.CheckboxSelectMultiple())
        ...
        object_ref = forms.MultipleChoiceField(choices=OBJECT_REF_CHOICES,required=False,widget=forms.CheckboxSelectMultiple())
        object_animacy = forms.MultipleChoiceField(choices=OBJECT_ANIMACY_CHOICES,required=False,widget=forms.CheckboxSelectMultiple())
        ...
        verb = forms.ModelMultipleChoiceField(queryset=Verb.objects.all().order_by('language__language','verb'),required=False)
